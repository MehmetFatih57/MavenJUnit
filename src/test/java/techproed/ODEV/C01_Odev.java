...
//       password.sendKeys("password");
        ...
        WebElement payBills = driver.findElement(By.cssSelector("#pay_bills_link"));
        payBills.click();
        Thread.sleep(2000);

        //8.amount kismina yatirmak istediginiz herhangi bir miktari yazin
        WebElement amount = driver.findElement(By.cssSelector("#sp_amount"));
        amount.sendKeys("1000" , Keys.TAB);
        Thread.sleep(2000);

        //9.tarih kismina “2020-09-10” yazdirin
         WebElement date = driver.findElement(By.cssSelector("#sp_date"));
         date.sendKeys("2020-09-10" , Keys.ENTER);


        //10.Pay buttonuna tiklayin
        WebElement payButton = driver.findElement(By.cssSelector("#pay_saved_payees"));
        payButton.click();
        Thread.sleep(2000);
